...
type DefaultRuleType<Rule extends DefaultRule> = (
  'default' extends keyof Rule ? (
    Rule['default'] extends (...args: any) => any ? ReturnType<Rule['default']> : (Rule['default'] extends undefined ? never : Rule['default'])
  ) : never
) | (
...
export type DecomposeRule<Rule extends ValidationRule> = Rule extends PrimitiveRule[] ? Rule[number] : Rule extends PrimitiveRule ? Rule : never;
